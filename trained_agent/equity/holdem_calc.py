import time
import equity.holdem_functions as holdem_functions
import equity.holdem_argparser as  holdem_argparser


def main():
    hole_cards, num, exact, board, file_name = holdem_argparser.parse_args()
    print(run(hole_cards, num, exact, board, file_name, True))
...
# Cards in Ad, Kh format
# return array [tie percentage, player 1 win percentage, player 2 win percentage]

...
def tournament(env, num):
    ...
    while counter < num:
        ...
        ev[0] += tie * (float(sum(env.get_perfect_information()['chips']))/2.0 - env.get_perfect_information()['chips'][0]) +\
                win * float(sum(env.get_perfect_information()['chips']) - env.get_perfect_information()['chips'][0]) 
        ev[1] += tie * (float(sum(env.get_perfect_information()['chips']))/2.0 - env.get_perfect_information()['chips'][1]) +\
